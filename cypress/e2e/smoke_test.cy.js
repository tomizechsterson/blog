...
describe('Smoke Test for Site', () => {
  it('should have header, top nav, and footer on the home page', () => {
    cy.visit('/')
  ...
  it('should navigate to first item on home page and back via header', () => {
    cy.visit('/')
  ...
  it('should display list of blog posts and navigate around them', () => {
    cy.visit('/blog')
  ...
  it('displays the projects page and navigate around projects', () => {
    cy.visit('/projects')
