...
<TOCInline toc={props.toc} asDisclosure exclude={"Introduction"} toHeading={2} />
...
[^4]:
    All that to say, at the end of the day the general rule of thumb is: Modify auto-generated files at your own risk.
[^5]:
