...
going off of straight-up memory, so, surely I won't forget anything. I did consider taking notes on a few occasions, but
decided it was too much work. This was probably not ideal.
...
even resets and is set up properly when the level is restarted, allowing the user to replay the level to their heart's
