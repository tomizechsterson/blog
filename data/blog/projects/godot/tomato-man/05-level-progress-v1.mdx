...
going off of straight-up memory, so what could possibly go wrong?
...
device, which sounds like a lot of work (I may be wrong about this...). Now, I'm not fundamentally against this or offended by
it, but I don't think this project warrants such things. Well ok, there is something that _does_ somewhat upset me: the only
