...
tags: ['godot', 'project', 'tomato-man', 'platformer', 'learning', 'animation']
...
the above project, each of those nodes in the state machine is an `AnimationNodeBlendSpace2D`, which allows you to play
